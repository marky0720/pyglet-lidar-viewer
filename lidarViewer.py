...
def main():
    ...
    file_path = "3D_XYZRGB_ColorOnDepth_#34.xyzrgb"# "3D_XYZRGB_DepthOnColor_#34.xyzrgb" #"test3D_11.xyzrgb"#"3D_XYZRGB_ColorOnDepth_#34.xyzrgb" # "test3D_11.xyzrgb"  #"PCL_DC.pcl"
    
    ##caption
    window.set_caption(file_path)
    #icon
    icon1 = pyglet.image.load('icon_16_16_#34.png')
    icon2 = pyglet.image.load('icon_32_32_#34.png')
